...
CREATE TABLE `permission` (
  ...
  `object_id` int(20) DEFAULT NULL COMMENT '实例ID',
  `typ` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '实例类型',
...
/*---------------------------create entity_user_role------------------------------------*/
CREATE TABLE `entity_user_role` (
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `role_id` bigint(20) NOT NULL COMMENT '角色ID',
  `created_by` bigint(20) DEFAULT NULL COMMENT '创建者ID',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`user_id`,`role_id`),
  KEY `entity_user_role_user_id_index` (`user_id`) USING BTREE,
  KEY `entity_user_role_role_id_index` (`role_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*---------------------------end create entity_user_role---------------------------------*/
...
/*---------------------------create entity_role_permission------------------------------------*/
CREATE TABLE `entity_role_permission` (
  `role_id` bigint(20) NOT NULL COMMENT '角色ID',
  `permission_id` bigint(20) NOT NULL COMMENT '权限ID',
  `created_by` bigint(20) DEFAULT NULL COMMENT '创建者ID',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`role_id`,`permission_id`),
  KEY `entity_role_permission_role_id_index` (`role_id`) USING BTREE,
  KEY `entity_role_permission_permission_id_index` (`permission_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*---------------------------end create entity_role_permission---------------------------------*/
...
CREATE TABLE `moudle` (
  ...
  `code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '编码',
  `path` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '当前路径',
  `is_left` int(11) DEFAULT 0 COMMENT '是否为叶子节点',
